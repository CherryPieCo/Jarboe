    ...
    <div id="main" role="main">
        ...
        <div id="content" class="container">
                ...
                <div class="b-login col-xs-12 col-sm-12 col-md-5 col-lg-4 " style="float: right;">
                    ...
                    <div class="b-top">
                        <?php $topBlock = config('jarboe.login.top_block'); echo $topBlock(); ?>
                    </div>
                    <div class="b-bottom">
                        <?php $bottomBlock = config('jarboe.login.bottom_block'); echo $bottomBlock(); ?>
                    </div>
                            ...
                            <fieldset>
                                ...
                                <section>
                                    ...
                                    <label class="input"> <i class="icon-append fa fa-user"></i>
                                        <input type="email" name="email" {{ config('jarboe.login.is_active_autocomplete') ?: 'readonly onfocus="this.removeAttribute(\'readonly\');"' }} >
                                ...
                                <section>
                                    ...
                                    <label class="input"> <i class="icon-append fa fa-lock"></i>
                                        <input type="password" name="password" {{ config('jarboe.login.is_active_autocomplete') ?: 'readonly onfocus="this.removeAttribute(\'readonly\');"' }} >
                                ...
                                @if (config('jarboe.login.is_active_remember_me'))
                                <section>
