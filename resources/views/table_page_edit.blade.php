...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
    <a href="{{ request()->url() }}" onclick="window.history.back();" class="btn btn-default">Previous page</a>
    <a href="{{ request()->url() }}" class="btn btn-info">Back to "{{ $definition->getOption('caption') }}" table</a>
</div>
</div>
</div>
@stop
...
TableBuilder.init({!! json_encode($definition->getOptions()) !!});
